...
namespace BubbleSortMethodFunction
{
    class Program
    {
        ...
        public static void NegativeOne(int[]arr) //Bolor array i elementnere dartsnume mek
        {
        ...
        public static void FiveElementsTwo(ref int[]a) //Array e sarqume 5 elementanots voir mej miayn 2 en
        {
            a = new int[5];
            for(int i = 0; i<5;i++)
            {
